...
<nav class="navbar navbar-expand-md bg">
  ...
  <!--Table-->
  <center>
    <h2  style="margin-top:50px; font-style: italic;color: gray;">Syllabus</h2>
<table class="table table-striped w-auto" style="margin-top: 10px;height: 430px;">
  ...
  <thead style="text-align: center;">
    <tr>
      ...
      <th style="color:gray;">Syllabus</th>
 ...
 <td >
   <img src="/uploadnote/{{$value->slbs}}" height="50px" width="50px" alt="" /> 
  </td>    
