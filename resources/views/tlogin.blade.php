...
<body>
  ...
  <div class="container py-5 h-25">
     <a href="\studentlogin"><img src="login.png" alt="student login" width="40" height="40"> </a>
       ...
       <div class="col-12 col-md-4 col-lg-6 col-xl-5"> 
        <div class="card  text-white" style="border-radius: 1rem;background-color: gray;">
          <div class="card-body p-4 text-center">
            ...
            <div class="mb-md-4 mt-md-4 pb-3">
              ...
              <div class="form-outline form-white mb-4">
              	<form action="/tloginaction" method="post" >
	           @csrf
          ...
          @endif
            ...
            <div>
              <p class="mb-0 pb-5 "  >Don't have an account? <a href="\tregister" class="text-white fw-bold">Sign Up</a>
              </p>
            </div>
