      ...
      <div class="col-lg-8 col-xl-6">
        <div class="card rounded-3">
          ...
          <div class="card-body p-4 p-md-5">
          	<center>
             <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 px-md-2">Add Timetable</h3>
             </center>


           <form method="post" enctype="multipart/form-data" action="\addtmetbleaction">
		        @csrf
               ...
               <div class=" mb-4" style="margin-left: 30px;">
              	 <label class="fw-bold"  >Add Timetable</label>

               <input type="file" name="tmetble" style="width:250px;margin-left: 30px;">
